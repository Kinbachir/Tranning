...
GO
PRINT N'Suppression de Contrainte de validation contrainte sans nom sur [dbo].[StockTransaction]...';


GO
ALTER TABLE [dbo].[StockTransaction] DROP CONSTRAINT [CK__StockTran__Trans__4222D4EF];
...
GO
PRINT N'Modification de Procédure [dbo].[GetAllProducts]...';
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.StockTransaction'))
               AND [type] IN (N'F', N'C')
